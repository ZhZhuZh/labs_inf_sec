...
author: "Жукова Виктория	НКНбд-01-19"
...
![Добавление  в группу и создание пользователей](image/1.png){ #fig:001 width=70% height=70% }
Рис. 1. Добавление  в группу и создание пользователей

4.	Выполнили вход в две учетные записи guest guest2 на разных консолях

![Разные консоли](image/2.png){ #fig:002 width=70% height=70% }
Рис. 2. Разные консоли
...
![Информация о директории](image/3.png){ #fig:002 width=70% height=70% }
Рис. 3. Информация о директории
...
Рис. 4. Информация о пользователях

7.	Сравнили полученную информацию с содержимым файла /etc/group. Посмотрели файл командой cat /etc/group.

![Содержимое файла /etc/group](image/5.png){ #fig:002 width=70% height=70% }
Рис. 5. Содержимое файла /etc/group
...
![Регистрация пользователя и изменение прав у директории](image/6.png){ #fig:004 width=70% height=70% }
Рис. 6. Регистрация пользователя и изменение прав у директории
